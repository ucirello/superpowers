...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    `jj --ignore-working-copy diff --from [BASE_REVISION] --to [TIP_REVISION] --context 10`.
...
- `[REPORT_FILE]` — REQUIRED: the file the implementer wrote its detailed
  report to
- `[BASE_REVISION]` — recorded commit ID before this task
- `[TIP_REVISION]` — recorded commit ID at the task tip
