...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    `jj diff --from [BASE_REVISION] --to [END_REVISION] --stat` and
    `jj diff --from [BASE_REVISION] --to [END_REVISION] --context 10`.
...
- `[REPORT_FILE]` — REQUIRED: the file the implementer wrote its detailed
  report to
- `[BASE_REVISION]` — full commit ID of the boundary before this task
- `[END_REVISION]` — full commit ID of the completed task boundary
