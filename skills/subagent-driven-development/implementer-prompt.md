...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **While you work:** If you encounter something unexpected or unclear, **ask questions**.
    ...
    standards. Repository-local commit-message syntax as established by project instructions and `git log`
    ALWAYS wins when it differs from the Go guidance. Do not use fixed templates
