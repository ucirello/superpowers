...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Fix base:** [FIX_BASE_REVISION] (the boundary the previous review saw)
    **End:** [END_REVISION]
    **Diff file:** [DIFF_FILE]
    ...
    `jj diff --from [FIX_BASE_REVISION] --to [END_REVISION] --stat` and
    `jj diff --from [FIX_BASE_REVISION] --to [END_REVISION] --context 10`.
...
- `[FIX_BASE_REVISION]` — full commit ID of the boundary the previous review saw
- `[END_REVISION]` — full commit ID of the completed fix boundary
