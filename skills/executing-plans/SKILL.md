...
1. Ensure an isolated workspace: create one with `jj workspace add -r 'trunk()' <destination>` or verify the existing workspace is dedicated to this work
2. Read plan file
...
- Never rewrite the `trunk()` revision without explicit user consent
