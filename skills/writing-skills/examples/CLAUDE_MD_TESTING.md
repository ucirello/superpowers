...
It works. Tests pass. your human partner asks you to describe and finalize the Jujutsu change.
...
B) Describe the current change with `jj describe` and start a new change with `jj new`
