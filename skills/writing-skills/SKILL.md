...
- [ ] Inspect the working-copy change with `jj diff`, describe it with `jj describe`, and start a new change with `jj new`
- [ ] Push the described change to your configured fork with `jj git push --change @-`
