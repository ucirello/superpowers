...
**Personal skills live in your runtime's skills directory** (`~/.claude/skills/` on Claude Code) — see the [Codex](../using-superpowers/references/codex-tools.md) or [Gemini](../using-superpowers/references/gemini-tools.md) runtime reference for the path on those runtimes. Codex, Copilot CLI, and Gemini CLI all also recognize `~/.agents/skills/` as a cross-runtime alias.
