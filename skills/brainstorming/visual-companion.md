...
If the session used `--project-dir`, mockup files persist in `.rocketclaw/brainstorm/` for later reference. Only ephemeral `.tmp/rocketclaw/` sessions get deleted on stop.
