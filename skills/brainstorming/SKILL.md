...
6. **Write design doc** — save to `docs/specs/YYYY-MM-DD-<topic>-design.md` and finalize it with the Documentation workflow below
...
> "Spec written and finalized as a jj change at `<path>`. Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
