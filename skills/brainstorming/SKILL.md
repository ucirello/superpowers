...
6. **Write design doc** — save to `docs/rocketclaw/specs/YYYY-MM-DD-<topic>-design.md` and record the change with Jujutsu
...
- Examine the current project state first (files, docs, and recent changes with `jj log`)
...
> "Spec written and recorded in Jujutsu at `<path>`. Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
